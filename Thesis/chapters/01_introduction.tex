...
\subsection{Hierarchical frustum culling}
\subsubsection{Superfrustum culling}
\subsubsection{Round robin culling}
\subsection{Software occlusion culling}
\subsubsection{Masked software occlusion culling}
\subsubsection{Round robin culling}
\subsection{Monoscopic far-field rendering}
\subsubsection{Variants}
\subsection{VR stencil mask}
...
\section{Further suggested and possible optimizations}
\section{Outlook}
...
\begin{itemize}
\item using Vulkan 1.1.?? and OpenVR 1.?? 
