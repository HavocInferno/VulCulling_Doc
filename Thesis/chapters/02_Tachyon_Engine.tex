...
More specific to \codeword{\gls{rtvklib}}, multiple Vulkan pipelines are active by default:
\begin{itemize}
...
void \gls{OpenVR}::RenderFrame()
{
	...
	\end{lstlisting}
  \end{tabular}
  \caption[\gls{OpenVR} render target's RenderFrame]{\gls{OpenVR} frame render function \textcolor{red}{[TODO: move to appendix, replace with compact flowchart]}}\label{fig:lst_OpenVR}_RenderFrame}
\end{figure}
