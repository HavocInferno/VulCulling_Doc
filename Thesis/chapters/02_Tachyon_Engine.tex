...
\begin{figure}[htb]
  ...
  \caption[VKRenderer's RenderFrame]{Renderer frame render function\textcolor{red}{[TODO: autoref code snippet in appendix]}}\label{fig:lst_VKRenderer_RenderFrame}
\end{figure} 
\iffalse
\begin{figure}[htb]
  \centering
...
\begin{figure}[htb]
  \centering
  \includegraphics[width=0.9\textwidth]{pictures/placeholder}
  \caption[VR render target's RecordCommandBuffers]{VR command buffer recording function\textcolor{red}{[TODO: autoref code snippet in appendix]}}\label{fig:lst_OpenVR_RecordCommandBuffers}
\end{figure} 
\iffalse
\begin{figure}[htb]
  \centering
...
\begin{figure}[htb]
  \centering
  \includegraphics[width=0.9\textwidth]{pictures/placeholder}
  \caption[VR render target's RenderFrame]{VR frame render function\textcolor{red}{[TODO: autoref code snippet in appendix]}}\label{fig:lst_OpenVR_RenderFrame}
\end{figure} 
\iffalse
\begin{figure}[htb]
  \centering
