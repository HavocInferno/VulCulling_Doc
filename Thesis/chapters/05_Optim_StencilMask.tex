...
\begin{figure}[h]
  \centering
  \hspace*{\fill}
     \subfloat[Stencil mask returned by SteamVR for the Valve Index]{%
       \includegraphics[width=0.4\textwidth]{pictures/index_home}
     }
  \hfill
  	\subfloat[Stencil mask returned by SteamVR for the Samsung Odyssey]{%
       \includegraphics[width=0.4\textwidth]{pictures/odyssey_home}
     }
  \hspace*{\fill}
  \hspace*{\fill}
     \subfloat[Stencil mask returned by SteamVR for the HTC Vive]{%
