...
\begin{figure}[h]
  \centering
  \hspace*{\fill}
     \subfloat[Stencil mask returned for the Valve Index]{%
       \includegraphics[width=0.4\textwidth]{pictures/index_home}
     }
  \hfill
  	\subfloat[Stencil mask returned for the Samsung Odyssey]{%
       \includegraphics[width=0.4\textwidth]{pictures/odyssey_home}
     }
  \hspace*{\fill}
  \hspace*{\fill}
     \subfloat[Stencil mask returned for the HTC Vive\textcolor{red}{[TODO: img]}]{%
       \includegraphics[width=0.4\textwidth]{pictures/vive_home}
     }
  \hfill
  	\subfloat[(lack of) Stencil mask returned for the Rift CV1]{%
