...
\begin{figure}[h]
  ...
  \hspace*{\fill}
     \subfloat[Stencil mask returned by SteamVR for the Index Vive]{%
       \includegraphics[width=0.4\textwidth]{pictures/placeholder}
     }
  \hfill
     \subfloat[Stencil mask returned by SteamVR for the Rift CV1]{%
       \includegraphics[width=0.4\textwidth]{pictures/placeholder}
     }
  \hspace*{\fill}
