...
\item Oculus Rift CV1 (1344x1600 pixels) - \textbf{WS-Big} functionality verification
\item Samsung Odyssey (0x0 pixels\textcolor{red}{[TODO]}) - \textbf{WS-Small} performance measurements, functionality verification
\end{itemize} 
