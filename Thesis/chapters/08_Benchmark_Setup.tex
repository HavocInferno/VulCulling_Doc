...
\end{itemize} 
Furthermore, the following virtual reality headsets were available with the respective interal per-eye resolution setting and in the respective capacity:
\begin{itemize}
