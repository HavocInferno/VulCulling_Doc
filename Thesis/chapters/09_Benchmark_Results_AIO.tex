...
\begin{figure}[H]
  \begin{center}
    \begin{tikzpicture}
      ...
      \end{axis}
    \end{tikzpicture}
    \caption{Best candidates comparison (Whole frame time, excluding SFRUST and MFFR configurations due to their negative scaling)} \label{fig:bmark_combined_whole}
  \end{center}
\end{figure}
\end{landscape}