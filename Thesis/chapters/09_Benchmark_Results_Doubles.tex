...
\begin{table}[H]
  \caption[Median/avg timings for frame/gpu/cull for baseline and combined optimizations]{Median and average (arithmetic mean) timings for frametime, gpu-time and cull-time for baseline and combined optimizations in milliseconds (rounded to two decimal places)}\label{tab:combined_medians}
  \centering
